...
/**
 * Base exception of all Zephyr exceptions.
 *
 * @author Andrea Funto'
 */
public class ZephyrException extends ServletException {
     ...
     */
    public ZephyrException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause   the exception's root cause.
     */
    public ZephyrException(String message, Throwable cause) {
        super(message, cause);
    }
