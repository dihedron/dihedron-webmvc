...
import org.dihedron.zephyr.annotations.*;
...
public class ActionProxyFactory {
     ...
     *
     * @param action       the action class to be instrumented.
     * @param doValidation whether JSR-349 bean validation related code should be generated in the
     *                     proxies.
     * @return the proxy object containing information about the Action factory method,
     ...
     *
     * @param action       the action for which a proxy must be created.
     * @param doValidation whether JSR-349 validation related code should be generated.
     * @return the <code>CtClass</code> object.
     * @throws DeploymentException
     */
     ...
     *
     * @param action the class to be scanned for the presence of instance fields.
     * @return whether the class and its super-classes declare any non-static field.
     */
     ...
     *
     * @param generator    the Javassist class generator.
     * @param action       the class of the action object.
     * @param doValidation whether JSR-349 validation code should be produced.
     * @return the Javassist object representing the factory method.
     * @throws DeploymentException
     */
     ...
     *
     * @param generator    the Javassist <code>CtClass</code> used to generate new static methods.
     * @param action       the action class to instrument.
     * @param method       the specific action method to instrument.
     * @param doValidation whether JSR349-compliant validation code should be output.
     * @return an instance of <code>CtMethod</code>, representing a static proxy method.
     * @throws DeploymentException
     */
