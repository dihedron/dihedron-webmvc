...
package org.dihedron.webmvc.renderers;
...
public interface Renderer {
     ...
     */
    void render(HttpServletRequest request, HttpServletResponse response, String data) throws IOException, WebMVCException;
}
