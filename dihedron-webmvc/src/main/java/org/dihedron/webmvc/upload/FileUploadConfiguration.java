 ...
 */ 
package org.dihedron.webmvc.upload;

import static org.dihedron.webmvc.Constants.KILOBYTE;
import static org.dihedron.webmvc.Constants.MEGABYTE;
...
public class FileUploadConfiguration {
	 ...
	 * provided one.
	 */
	public static final String DEFAULT_UPLOAD_DIRECTORY = "/tmp/webmvc-${server}-${port}";
