...
import org.dihedron.core.reflection.filters.IsPublic;
	...
	public class ActionProxyBuilderContext {
		...
		public ActionProxyBuilderContext addBusinessMethod(Method method) throws DeploymentException {
			...
			try {
				...
				if (doValidation) {
					...
					code.append("\torg.dihedron.webmvc.validation.ValidationHandler handler = null;\n");
				}
				code.append("\n");
		...
		private String prepareInputArgument(int i, Type type, In in, StringBuilder preCode, boolean doValidation) throws DeploymentException {
			...
			for (Scope scope : in.from()) {
				preCode.append(first ? "" : ", ").append("org.dihedron.webmvc.protocol.Scope.").append(scope.name());
				first = false;
			}
			preCode.append(" });\n");
		...
		private String prepareOutputArgument(int i, Type type, Out out, StringBuilder preCode, StringBuilder postCode, boolean doValidation)
			...
			postCode.append("\t\torg.dihedron.webmvc.ActionContext.setValue(\"").append(out.value())
					.append("\", value, org.dihedron.webmvc.protocol.Scope.").append(scope.name()).append(");\n");
			postCode.append("\t} else if(").append(variable).append(".isReset()) {\n");
			postCode.append("\t\torg.dihedron.webmvc.ActionContext.removeValue(\"").append(parameter).append("\", ")
					.append("org.dihedron.webmvc.protocol.Scope.").append(scope.name()).append(");\n");
			postCode.append("\t}\n");
			postCode.append("\n");
		...
		private String prepareInOutArgument(int i, Type type, InOut inout, StringBuilder preCode, StringBuilder postCode, boolean doValidation)
			...
			for (Scope scope : inout.from()) {
				preCode.append(first ? "" : ", ").append("org.dihedron.webmvc.protocol.Scope.").append(scope);
				first = false;
			}
			preCode.append(" });\n");
			...
			postCode.append("\tvalue = ").append(variable).append(".get();\n");
			postCode.append("\tif(value != null) {\n");
			postCode.append("\t\torg.dihedron.webmvc.ActionContext.setValue(\"").append(inout.value())
					.append("\", value, org.dihedron.webmvc.protocol.Scope.").append(inout.to().name()).append(");\n");
			postCode.append("\t} else if(").append(variable).append(".isReset()) {\n");
			postCode.append("\t\torg.dihedron.webmvc.ActionContext.removeValue(\"").append(parameter).append("\", ")
					.append("org.dihedron.webmvc.protocol.Scope.").append(inout.to().name()).append(");\n");
			postCode.append("\t}\n");
			postCode.append("\n");
		...
		private String prepareInputModelArgument(int i, Type type, Model model, String action, Method method, StringBuilder preCode,
			...
			preCode.append("\t\t\torg.dihedron.webmvc.ognl.OgnlExpression ognl = new org.dihedron.webmvc.ognl.OgnlExpression(key);\n");
		...
		private String prepareInputOutputModelArgument(int i, Type type, Model model, Out out, String action, Method method, StringBuilder preCode,
			...
			preCode.append("\torg.dihedron.webmvc.aop.$ ").append(variable).append(" = new org.dihedron.webmvc.aop.$(new ")
					.append(Types.getAsString(wrapped)).append("());\n");
			preCode.append("\tognl.OgnlContext context = new ognl.OgnlContext();\n");
			...
			postCode.append("\t\torg.dihedron.webmvc.ActionContext.setValue( \"").append(out.value())
					.append("\", value, org.dihedron.webmvc.protocol.Scope.").append(scope.name()).append(" );\n");
			postCode.append("\t} else if(").append(variable).append(".isReset()) {\n");
			// postCode.append("\t\torg.dihedron.webmvc.ActionContext.removeValueFromScope( \"").append(parameter).append("\", ").append("org.dihedron.webmvc.protocol.Scope.").append(scope.name()).append(" );\n");
			postCode.append("\t\torg.dihedron.webmvc.ActionContext.removeValue( \"").append(parameter).append("\", ")
					.append("org.dihedron.webmvc.protocol.Scope.").append(scope.name()).append(" );\n");
			postCode.append("\t}\n");
			postCode.append("\n");
