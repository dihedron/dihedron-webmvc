...
public class TargetId {
	 ...
	 */
	public TargetId(String targetId) throws WebMVCException {
	 ...
	 */
	public TargetId(String actionName, String methodName) throws WebMVCException {
		if (!Strings.isValid(actionName)) {
			logger.error("invalid action name in target id creation");
			throw new WebMVCException("Invalid action name specified");
		}
	 ...
	 */
	private static String getActionName(String targetId) throws WebMVCException {
		...
		if (Strings.isValid(targetId)) {
			...
			throw new WebMVCException("Invalid target specified");
		}
	}
