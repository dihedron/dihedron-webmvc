...
/**
 * The MultipartMap. It simulates the <code>HttpServletRequest#getParameterXXX()
 * </code> methods to ease the processing in <code>@MultipartConfig</code> 
 * servlets. You can access the normal request parameters by <code>
 * {@link #getParameter(String)}</code> and you can access multiple request 
 ...
 * fields, the <code>${parts.filefieldname}</code> returns a <code>{@link File}</code>.
 * <p>
